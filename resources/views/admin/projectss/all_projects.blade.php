                ...
                <table class="table table-striped projects">
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="/admin/projects/roofs/ ">
                                <i class="fas fa-folder">
                                </i>
                                Projects
                            </a>
                            <a class="btn btn-info btn-sm" href="/admin/roofs/1">
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            ...
                            <a class="btn btn-danger btn-sm" href="/admin/roofs/2">
                                <i class="fas fa-trash">
                                </i>
                                OFF
                            </a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <small>
                                Calculation of the wall (wallpaper)
                            </small>
                        </td>
                        <td>
                            <ul class="list-inline">
                        ...
                        <td class="project-actions text-right">
                            <a class="btn btn-primary btn-sm" href="/admin/roofs/3">
                                <i class="fas fa-folder">
                                </i>
                                Users
                            </a>
